...
/**
    ...
    * 
     * @see <a href="https://developers.line.biz/en/reference/liff-server/#add-liff-app"> Documentation</a>
    */
    public async addLIFFAppWithHttpInfo(addLiffAppRequest: AddLiffAppRequest, ) : Promise<Types.ApiResponseType<AddLiffAppResponse>> {
...
/**
    ...
    * 
     * @see <a href="https://developers.line.biz/en/reference/liff-server/#delete-liff-app">Delete LIFF app from a channel Documentation</a>
    */
    public async deleteLIFFAppWithHttpInfo(liffId: string, ) : Promise<Types.ApiResponseType<Types.MessageAPIResponseBase>> {
...
/**
    ...
    * 
     * @see <a href="https://developers.line.biz/en/reference/liff-server/#get-all-liff-apps">Get all LIFF apps Documentation</a>
    */
    public async getAllLIFFAppsWithHttpInfo() : Promise<Types.ApiResponseType<GetAllLiffAppsResponse>> {
...
/**
    ...
    */
    public async updateLIFFApp(liffId: string, updateLiffAppRequest: UpdateLiffAppRequest, ) : Promise<Types.MessageAPIResponseBase> {
        return (await this.updateLIFFAppWithHttpInfo(liffId, updateLiffAppRequest, )).body;
    }
    ...
    * 
     * @see <a href="https://developers.line.biz/en/reference/liff-server/#update-liff-app"> Documentation</a>
    */
    public async updateLIFFAppWithHttpInfo(liffId: string, updateLiffAppRequest: UpdateLiffAppRequest, ) : Promise<Types.ApiResponseType<Types.MessageAPIResponseBase>> {

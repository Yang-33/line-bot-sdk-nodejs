...
describe("MessagingApiBlobClient", () => {
  ...
  it("getMessageContentWithHttpInfo", async () => {
    ...
    const server = createServer((req, res) => {
      ...
      equal(reqUrl.pathname, "/v2/bot/message/{messageId}/content"
  ...
  it("getMessageContentTranscodingByMessageIdWithHttpInfo", async () => {
    ...
    const server = createServer((req, res) => {
      ...
      equal(req.method, "GET");
      const reqUrl = new URL(req.url, "http://localhost/");
      equal(reqUrl.pathname, "/v2/bot/message/{messageId}/content/transcoding"
        .replace("{messageId}", "DUMMY") // string
  ...
  it("getRichMenuImageWithHttpInfo", async () => {
    ...
    const server = createServer((req, res) => {
      ...
      equal(req.method, "GET");
      const reqUrl = new URL(req.url, "http://localhost/");
      equal(reqUrl.pathname, "/v2/bot/richmenu/{richMenuId}/content"
